...
class capstontest(unittest.TestCase):
    ...
    def test_get_actors(self):
        res = self.client().get('/actors', headers=Producer)
    ...
    def test_get_movies(self):
        res = self.client().get('/movies', headers=Producer)
        data = json.loads(res.data)
    ...
    def test_create_new_actors(self):
        ...
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['created_id'], 3)
    ...
    def test_create_new_movies(self):
        res = self.client().post(
            ...
            json={
                ...
                "title": "BoyzBeforFlower1"})
        data = json.loads(res.data)

        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['created_id'], 4)
